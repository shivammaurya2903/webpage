...
const bookingSchema = new mongoose.Schema(
  {
    ...
    bookingSignature: { type: String, unique: true, sparse: true, index: true },
    ...
    pickupCoordinates: { type: [Number], default: null },
    dropCoordinates: { type: [Number], default: null },
    destinationCoordinates: { type: [Number], default: null },
